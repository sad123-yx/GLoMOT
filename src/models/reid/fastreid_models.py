...
from fast_reid.fastreid.data.build import build_transforms

#_WEIGHTS_DIR = osp.join(root,'fastreid-models')
_WEIGHTS_DIR = osp.join(root,'pretrained')
_FASTREID_MODEL_ZOO = {'msmt_SBS_R101_ibn': ('configs/MSMT17/sbs_R101-ibn.yml', 'model_weights/msmt_sbs_R101-ibn.pth'),
                        ...
                        'dancetrack_sbs_S50':('configs/Dancetrack/sbs_S50.yml', 'dancetrack_sbs_S50.pth'),
                        'mot17_sbs_S50':('configs/MOT17/sbs_S50.yml', 'mot17_sbs_S50.pth'),
                        'mot20_sbs_S50':('configs/MOT20/sbs_S50.yml', 'mot20_sbs_S50.pth'),
                        'sportsmot_sbs_S50':('configs/SportsMOT/sbs_S50.yml', 'sportsmot_sbs_S50.pth')
                        }            
