import numpy as np
from src.utils.graph_utils import iou_pairs
...
class GraphAugmentor:
    ...
    box coordinates.
    """
    def __init__(self, graph_df, config):
    ...
    def _drop_ids(self):
        ...
        ids_to_drop_perc = np.random.uniform(self.config.min_ids_to_drop_perc,
                                             self.config.max_ids_to_drop_perc)
    ...
    def _drop_detections(self):
        ...
        detects_to_drop_perc = np.random.uniform(self.config.min_detects_to_drop_perc,
                                                 self.config.max_detects_to_drop_perc)
    ...
    def _wiggle_boxes(self):
        ...
        min_iou = self.config.min_iou_bb_wiggling
